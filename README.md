...
```
cd existing_repo
git remote add origin https://gitlab.engr.illinois.edu/gdurand2/cs425_mp1.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.engr.illinois.edu/gdurand2/cs425_mp1/-/settings/integrations)
